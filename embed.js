  ...
  const htmlContent = `
    <div class="story-container" id="stories">
      <div class="story" id="story-1">
        ...
        <div class="story-title">${title1}</div>
      </div>
      <div class="story" id="story-2">
        <div class="story-image">
          <img src="" alt="${title2} Thumbnail">
          <div class="play-button-overlay">
            <svg viewBox="0 0 24 24">
              <path d="M8 5v14l11-7z"></path>
            </svg>
        ...
        <div class="story-title">${title2}</div>
      </div>
      <div class="story" id="story-3">
        <div class="story-image">
          <img src="" alt="${title3} Thumbnail">
          <div class="play-button-overlay">
            <svg viewBox="0 0 24 24">
              <path d="M8 5v14l11-7z"></path>
            </svg>
        ...
        <div class="story-title">${title3}</div>
      </div>
    </div>
